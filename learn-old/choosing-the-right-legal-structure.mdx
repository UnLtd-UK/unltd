...
description: This guide explores the typical legal structures that are used in the social enterprise sector, the core advantages and disadvantages of the respective structures, and the key issues for consideration when deciding on the right legal structure for your organisation
created: 
updated: 
reviewed: 
breadcrumbs: [
