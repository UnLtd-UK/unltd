...
export default function FeedbackPopover() {
    ...
    return (
        <Popover className="relative">
            ...
            <Popover.Panel className="absolute -left-48 mt-2 z-10 border-1 bg-violet-950 border-violet-900 max-w-lg p-4 rounded-2xl shadow-6xl w-80">
                {isSubmitted ? (
            ...
            hover:bg-blue-100 transition"><i className="fa-solid fa-lightbulb text-blue-800"></i><span className="text-blue-900">Feature</span></label>
