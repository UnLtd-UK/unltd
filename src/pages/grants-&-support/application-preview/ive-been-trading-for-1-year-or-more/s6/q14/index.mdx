...
breadcrumbs: [
          ...
          },
          {
            ...
            slug: "/grants-&-support/application-preview",
          },
          {
            name: "I've been trading for 1 year or more",
            slug: "/grants-&-support/application-preview/ive-been-trading-for-1-year-or-more",
          },
        {
            name: "File uploads",
            slug: "/grants-&-support/application-preview/ive-been-trading-for-1-year-or-more/s6/q14",
          },
        ]
---
...
<AButton
     name="Download template"
              href="https://www.unltd.org.uk/uploads/general_uploads/financial-data-template.xlsx"
...
![Detail of tab navigation at the bottom of the spreadsheet. An arrow indicates the place to click to navigate to 'Last 12 months'](https://www.unltd.org.uk/uploads/general_images/findata_image2.webp)
...
<Note>
  ...
  <img src="https://www.unltd.org.uk/uploads/general_images/findata_image3.webp" alt="Detail showing the navigation to add sheet rows as explained above."/>
</Note>
...
![Detail indicating where to input the names of each product. Write the name of the first product in the cell below “income”](https://www.unltd.org.uk/uploads/general_images/findata_image4.webp)
...
![Example showing how to work out a sales budget on scrap paper. The example shows this calculation: Cappuccinos at 1.75 (price per unit) x 65 (units to sell) = 113.75 total sales (for that item).](https://www.unltd.org.uk/uploads/general_images/findata_image5.webp)
...
![Detail showing how to enter the total sales for each item in the cell corresponding to the correct item and month.](https://www.unltd.org.uk/uploads/general_images/findata_image6.webp)
...
![Example showing how to work out variable costs on scrap paper. The example shows this calculation: Cheese at a cost of 20p per unit (for sandwiches) x 120 (units to sell) = £24 total costs (for that item).](https://www.unltd.org.uk/uploads/general_images/findata_image7.webp)
