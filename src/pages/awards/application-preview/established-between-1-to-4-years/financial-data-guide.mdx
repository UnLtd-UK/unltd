...
breadcrumbs: [
          ...
          {
            name: Established between 1 to 4 years,
            slug: /awards/application-templates/established-between-1-to-4-years,
          },
        {
            name: Financial data guide,
            slug: /awards/application-templates/established-between-1-to-4-years/financial-data-guide,
          },
        ]
---
