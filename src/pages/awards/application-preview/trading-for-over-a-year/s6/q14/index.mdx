...
breadcrumbs: [
          ...
          {
            name: "Trading for over a year",
            slug: "/awards/application-preview/trading-for-over-a-year",
          },
        {
            name: "File uploads guidance",
            slug: "/awards/application-preview/trading-for-over-a-year/s6/q14",
          },
        ]
---
...
<AButton
     name="Download template"
              href="http://127.0.0.1:8090/api/files/applications/y2ctsk5ru12pcmc/financial_data_awards_application_un_ltd_4LkMblKY7r.xlsx"
...
![Detail of tab navigation at the bottom of the spreadsheet. An arrow indicates the place to click to navigate to 'Last 12 months'](/img/findata_image2.webp)
...
<Note>
  ...
  <img src="/img/findata_image3.webp" alt="Detail showing the navigation to add sheet rows as explained above."/>
</Note>
...
![Detail indicating where to input the names of each product. Write the name of the first product in the cell below “income”](/img/findata_image4.webp)
...
![Example showing how to work out a sales budget on scrap paper. The example shows this calculation: Cappuccinos at 1.75 (price per unit) x 65 (units to sell) = 113.75 total sales (for that item).](/img/findata_image5.webp)
...
![Detail showing how to enter the total sales for each item in the cell corresponding to the correct item and month.](/img/findata_image6.webp)
...
![Example showing how to work out variable costs on scrap paper. The example shows this calculation: Cheese at a cost of 20p per unit (for sandwiches) x 120 (units to sell) = £24 total costs (for that item).](/img/findata_image7.webp)
