...
name: Resources
description: The social entrepreneurship ecosystem is vast, and we want to help you find the right support for you and your enterprise. Below are organisations and useful resources which might be able to help you progress in your journey.
created: 
updated: 
reviewed:   
breadcrumbs: [
...
A leading global authority on social enterprise and large network of social enterprises in the UK. [Explore their directorate for learning resources and tools](https://directory.socialenterprise.org.uk).
