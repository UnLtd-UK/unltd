...
export const socialVentureCriteria: CriterionMapping[] = [
    { slug: 'social_purpose_driven', name: 'Is your social venture clearly driven by its social purpose?', category: 'social_venture' },
    { slug: 'clear_need_demonstrated', name: 'Can you demonstrate a clear need for your social venture?', category: 'social_venture' },
    { slug: 'benefits_uk_people_places', name: 'Does your social venture mainly benefit people or places within the UK?', category: 'social_venture' },
    { slug: 'activities_running_4_years', name: 'Is your social venture continuing activities that have already been running for more than four years?', category: 'social_venture' },
    { slug: 'lawful_not_discriminatory', name: 'Does your social venture involve activities outside of the law, against public policy or anything which encourages ethnic, religious, or commercial disharmony?', category: 'social_venture' },
    { slug: 'no_political_religious_campaign', name: 'Does your social venture involve political, or religious campaigning?', category: 'social_venture' },
    { slug: 'more_than_awareness_raising', name: 'Does your social venture do more than just raise awareness of a social issue?', category: 'social_venture' },
    { slug: 'financially_sustainable', name: 'Does your social venture have the potential to be financially sustainable with our support?', category: 'social_venture' },
    { slug: 'incorporation_timeframe', name: 'How long has your social venture been incorporated?', category: 'social_venture' },
    { slug: 'started_trading', name: 'Has your social venture started trading?', category: 'social_venture' },
