/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 52a766a9caf898fbc06262a92959224f)
// Runtime types generated with workerd@1.20260722.1 2025-11-17 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DEV: "false" | "true";
	SHOW_DRAFTS: "false" | "true";
	EVENTBRITE_PRIVATE_TOKEN: string;
	FONTAWESOME_NPM_AUTH_TOKEN: string;
	TYPEFORM_API: string;
	DIRECTUS_PREVIEW_TOKEN: string;
}
